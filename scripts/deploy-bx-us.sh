...
#----------------------------------------------
cd ~/ibm-cloud-architecture/refarch-cloudnative-netflix-hystrix
...
cf ic group create --name spring-config -p 8888 -m 512 --min 1 --max 2 --desired 1 --env-file scripts/env-spring-config-remote registry.ng.bluemix.net/supercontainers/spring-config:dev
...
# echo "appetizer"
cf ic group create --name appetizer -p 8082 -m 512 --min 1 --max 2 --desired 1 --env-file scripts/env-only-spring-config-remote registry.ng.bluemix.net/supercontainers/wfd-appetizer:dev

echo "sleeping 10"
sleep 10 

echo "dessert"
cf ic group create --name dessert -p 8083 -m 256 --min 1 --max 2 --desired 1 --env-file scripts/env-only-spring-config-remote registry.ng.bluemix.net/supercontainers/wfd-dessert:dev

echo "sleeping 10"
sleep 10

echo "entree"
cf ic group create --name entree -p 8081 -m 256 --min 1 --max 2 --desired 1 --env-file scripts/env-only-spring-config-remote registry.ng.bluemix.net/supercontainers/wfd-entree:dev

echo "sleeping 120"
sleep 120

echo "create group for menu, pass in Eureka"
cf ic group create --name menu -p 8180 -m 512 --min 1 --max 2 --desired 1 --env-file scripts/env-eureka-only-remote registry.ng.bluemix.net/supercontainers/wfd-menu:dev

echo "sleeping 60"
sleep 60

echo "create group for wfd-ui, pass in Eureka"
cf ic group create --name wfd-ui -p 8181 -m 512 --min 1 --max 2 --desired 1 --env-file scripts/env-eureka-only-remote registry.ng.bluemix.net/supercontainers/wfd-ui:dev
...
cf ic run --name netflix-turbine -p 8989 -m 512 --env-file scripts/env-eureka-only-remote registry.ng.bluemix.net/supercontainers/netflix-turbine:dev
...
cf ic group create --name netflix-zuul -p 8080 -m 512 --auto --min 1 --max 2 --desired 1 --env-file scripts/env-zuul-remote registry.ng.bluemix.net/supercontainers/netflix-zuul:dev
...
# cf ic group create --name netflix-hystrix -p 8383 -m 512 --min 1 --max 2 --desired 1 --env-file scripts/env-eureka-only-remote registry.ng.bluemix.net/supercontainers/netflix-hystrix:dev
cf ic run --name netflix-hystrix -p 8383 -m 512 --env-file scripts/env-eureka-only-remote registry.ng.bluemix.net/supercontainers/netflix-hystrix:dev
