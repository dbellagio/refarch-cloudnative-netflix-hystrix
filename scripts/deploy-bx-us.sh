...
echo "# spring_rabbitmq_addresses=amqp://fqqsbyyd:<the-password>@white-swan.rmq.cloudamqp.com/fqqsbyyd" >> ${AMQP_ENV_FILE}
echo "" >> ${AMQP_ENV_FILE}
...
echo "spring.rabbitmq.password=<the-password>" >> ${AMQP_ENV_FILE}
